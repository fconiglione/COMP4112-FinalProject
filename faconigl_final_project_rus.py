...
print("K-Nearest Neighbor test set score: {:.2f}".format(np.mean(pred == y_test)))
...
print("Decision Tree test set score: {:.2f}".format(np.mean(pred == y_test)))
...
print("Random Forest test set score: {:.2f}".format(np.mean(pred == y_test)))
...
print("Logistic Regression test set score: {:.2f}".format(np.mean(pred == y_test)))
